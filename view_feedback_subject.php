    ...
    <div class="row decor_bg">
        <div class="col-md-8 col-md-offset-2" style="margin-top: 4rem;">
            <table class="table table-striped">
                <?php
                $query = "SELECT * FROM subjectfeedback WHERE teacher_id=$teacher_id";
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result)) { ?>
                            <tr>
                                ...
                                <td><a href="subject_feedback_remove.php?id=<?php echo $row["SNo"]; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
                            </tr>
                        <?php
                        } ?>
                    </tbody>
                <?php
                    ...
                    echo "<center><h2>There isn't any Feedback regarding a Subject for You.</h2></center>";
                }
                ?>
            </table>
        </div>
