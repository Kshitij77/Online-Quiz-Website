...
<html>
    <head>
        <title>Add Course  |  Online Quiz System</title>
                ...
                <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                    <div class="panel panel-primary" style="font-family:'Poppins'">
                        ...
                        <div class="panel-body">
                            <form  action="add_course_script.php" method="POST">
                            <div class="form-group ">
                                <input class="form-control" placeholder="Course Name" name="course_name"  required>
                                <?php
                                if(isset($_GET["m1"])){
                                  echo $_GET['m1'];
                                }
