...
<html>
    <head>
        <title>Quiz Feedback  |  Online Quiz System</title>
                ...
                <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                    <div class="panel panel-primary" style="font-family:'Poppins'">
                        ...
                        <div class="panel-body">
                            <form  action="quiz_feedback_script.php" method="POST">
                            ...
                            <div class="form-group ">
                                <textarea name="message" id="message" required="required" class="form-control" rows="7" placeholder="Write your valuable feedback for the quiz here..."></textarea>
                            </div>
