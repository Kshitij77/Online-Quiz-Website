        ...
        <div class="row decor_bg">
            <div class="col-md-8 col-md-offset-2">
               <table class="table table-striped">
                   <?php
                      $query = "SELECT * FROM commonquizfeedback";
                   ...
                   <tbody>
                      ...
                      while ($row = mysqli_fetch_array($result)) { ?>
                             ...
                             <td><a href="common_feedback_remove.php?id=<?php echo $row["SNo"]; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
                             </tr>
                             <?php
                              }?>
                   </tbody>
                   <?php
                            ...
                            echo "<center><h2>There isn't any Common Feedback regarding any Quiz.</h2></center>";
                           }
                   ?>
               </table>
             </div>
