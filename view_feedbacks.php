...
<body style="padding-top: 200px;">
  ...
  <a href="view_feedback_quiz.php"><button class="block">Quiz Feedbacks</button></a>
  <br><br><br>
  <a href="view_feedback_subject.php"><button class="block">Subject Feedbacks</button></a>
</body>
