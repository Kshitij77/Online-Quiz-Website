...
<head>
    ...
    <title>Teacher Settings | Online Quiz System</title>
            ...
            <div class="row ">
                <div class="col-lg-4 col-lg-offset-1 col-md-6 col-md-offset-1">
                    <div class="panel panel-primary" style="font-family:'Poppins'">
                        ...
                        <div class="panel-body">
                            ...
                            $que = "SELECT * FROM teacher WHERE teacher_id=$teacher_id";
                            $res = mysqli_query($con, $que) or die(mysqli_error($con));
                            while ($row = mysqli_fetch_array($res)) {
                            ?>
                                <form action="update_teacher.php?id=<?php echo $teacher_id; ?>" method="POST">
                ...
                <div class="col-lg-4 col-lg-offset-2 col-md-6 col-md-offset-1">
                    <div class="panel panel-primary" style="font-family:'Poppins'">
                        ...
                        <div class="panel-body">
                            <form action="teacher_settings_script.php" method="POST">
