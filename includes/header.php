<div class="navbar navbar-inverse navbar-fixed-top">
     <div class="container">
           <div class="navbar-header">
               ...
               <a class="navbar-brand" href="index.php" ><span class="flogotxt">Online</span>&nbsp;<span class="slogotxt">Quiz System</span></a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                      <li><a href="admin_login.php"><span class="glyphicon glyphicon-log-in"></span> Admin LogIn</a></li>
                      <li><a href="teacher_login.php"><span class="glyphicon glyphicon-log-in"></span> Teacher LogIn</a></li>
