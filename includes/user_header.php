<div class="navbar navbar-inverse navbar-fixed-top">
     <div class="container">
          <div class="navbar-header">
               ...
               <a class="navbar-brand" href="user.php"><span class="flogotxt">Online</span>&nbsp;<span class="slogotxt">Quiz System</span></a>
          </div>
          <div class="collapse navbar-collapse" id="myNavbar">
               <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="user_settings.php"><?php echo " " . $_SESSION['name']; ?></a></li>
