    ...
    <div class="col-sm-9">
	  ...
	  <h2 class="title">Contact Info</h2>
	       ...
	       <div><h2 class="title">Follow Us On&#58;</h2>
                        <a href="https://twitter.com/harshjais4" class="twitter-follow-button" data-show-count="false">Follow @TwitterDev</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                      </div>
            </div>
        </div>
    </div>
