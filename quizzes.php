        ...
        <div class="col-md-12">
            <table class="table table-striped">
                ...
                ?>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($result)) { ?>
                            <tr>
                                <td><a href="edit_quiz.php?id=<?php echo $row["quiz_id"]; ?>"><?php echo $row["quiz_id"]; ?></a></td>
                                <td><a href="edit_quiz.php?id=<?php echo $row["quiz_id"]; ?>"><?php echo $row["quiz_name"]; ?></a></td>
                ...
                <?php
                    ...
                    echo "<center><h2>There isn't any Quiz yet.</h2></center>";
                }
                ?>
            </table>
        </div>
